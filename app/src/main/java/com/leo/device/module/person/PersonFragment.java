package com.leo.device.module.person;
...
import com.leo.device.module.about.AboutActivity;
...
import com.leo.device.module.network.NetworkActivity;
...
public class PersonFragment extends BaseFragment {
    ...
    static class Box extends BaseFragmentBox<Object> {
        ...
        AppCompatTextView tvThreshold;
        @BindView(R.id.bNetwork)
        LinearLayout bNetwork;
        @BindView(R.id.bBluetooth)
        LinearLayout bBluetooth;
        @BindView(R.id.bLogout)
        AppCompatTextView bLogout;


        @BindView(R.id.bAbout)
        LinearLayout bAbout;
            ...
            Observable.just(bean)
                    ...
                    .subscribe(new Observer<User>() {
                        ...
                        public void onNext(User user) {
                            ...
                            tvGender.setText(user.getSex() == 0 ? getContext().getString(R.string.women) : getContext().getString(R.string.man));
                            tvThreshold.setText(String.valueOf(user.getThreshold()));
                            tvHeight.setText(String.valueOf(user.getHeight()));
                            tvWeight.setText(String.valueOf(user.getWeight()));
                            tvBmi.setText(String.valueOf(user.getBmi()));
                        }
